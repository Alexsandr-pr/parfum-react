            ...
            <div className="main__items-in-cart items-in-cart">
            ...
            
                {
                        dataCart.length > 0 && <CartModal 
                                                    text={"Заказы до 10 000 доставим бесплатно в Ваш ближайший постамат. если в Вашем регионе их нет, то так же бесплатно доставим в Ваше отделение УкрПочты. Заказы свыше 10 000 доставим курьером до двери."}
                                                    childrenLink={
